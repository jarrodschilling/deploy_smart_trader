...
export default function Header() {
  return (
    <nav className="bg-white dark:bg-gray-950 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <a href="/" className="border px-2 py-1 bg-slate-800 flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/everest.jpeg" alt="" className="h-10"></img>
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Smart Trader</span>
      </a>
